...
helpText    BYTE "Operators Definition Rules",0dh,0ah,0dh,0ah
			...
			BYTE "The operators in this group are used to perform various mathematical functions on the operands. They have the highest precedence and are evaluated from left to right."
			...
			BYTE "SQRT: This operator calculates the square root of the operand. For example, SQRT 25 returns 5, which is √25.",0dh,0ah
			...
			BYTE "TAN: This operator calculates the tangent of the operand in radians. For example, TAN 0.7854 returns , which is tan(pi/4).",0dh,0ah
			...
			BYTE "and are evaluated from left to right. The operands must be numerical values or expressions that can be evaluated to numerical values. The operators and their definitions are as follows:",0dh,0ah
			...
			BYTE "The operators in this group are used to perform addition and subtraction operations on the operands. They have the third highest precedence and are evaluated from left to right. ",0dh,0ah
			...
			BYTE "The operators in this group are used to perform unary operations on the operand. They have the fourth highest precedence and are evaluated from right to left. ",0dh,0ah
			...
			BYTE "IN: This operator reads a numerical value from the standard input and returns it as the operand. For example, IN returns the value entered by the user.",0dh,0ah
			BYTE "OUT: This operator writes the value of the operand to the standard output. For example, OUT 5 prints 5 to the screen.",0dh,0ah
			...
			BYTE "The operators in this group are used to compare the equality of the operands. They have the fifth highest precedence and are evaluated from left to right. ",0dh,0ah
			BYTE "The operands must be numerical values or expressions that can be evaluated to numerical values. The operators and their definitions are as follows:",0dh,0ah
			BYTE "==: This operator returns 1 if the first operand is equal to the second operand, or 0 otherwise. For example, 3 == 4 returns 0, which is false.",0dh,0ah
			BYTE "!=: This operator returns 1 if the first operand is not equal to the second operand, or 0 otherwise. For example, 3 != 4 returns 1, which is true.",0dh,0ah,0dh,0ah
			BYTE "Group 6: Logical Operators",0dh,0ah,0dh,0ah
			BYTE "The operators in this group are used to perform logical operations on the operands. They have the sixth highest precedence and are evaluated from left to right. ",0dh,0ah
			BYTE "The operands must be numerical values or expressions that can be evaluated to numerical values. The operators and their definitions are as follows:",0dh,0ah
			BYTE "&&: This operator returns 1 if both operands are non-zero, or 0 otherwise. For example, 1 && 0 returns 0, which is false.",0dh,0ah
			BYTE "||: This operator returns 1 if either operand is non-zero, or 0 otherwise. For example, 1 || 0 returns 1, which is true.",0dh,0ah,0dh,0ah
			BYTE "Group 7: Assignment Operator",0dh,0ah,0dh,0ah
			BYTE "The operator in this group is used to assign the value of the second operand to the first operand. It has the lowest precedence and is evaluated from right to left. ",0dh,0ah
